...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item $amount\_selled$ $\to$ Representa la cantidad de unidades del producto que la tienda es capaz de venderle al cliente (depende del inventario en ese momento).
        \end{itemize}
...
\begin{itemize}
    ...
    \item Se asume que el tiempo de atención al cliente es instantáneo. Por esto en nuestra simulación ningún cliente debe esperar en una cola a ser atendido.
